...
- Version history: [`CHANGELOG.md`](https://github.com/habibuslam5-a11y/sagor-fca/blob/main/CHANGELOG.md) in the repository (not shipped in the npm tarball).
